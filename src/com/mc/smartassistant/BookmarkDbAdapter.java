...
public class BookmarkDbAdapter {
    ...
    /**
     * Create a new location using the title and body provided. If the location is
     ...
     * @param title value to set location title to
     * @param body value to set location body to
